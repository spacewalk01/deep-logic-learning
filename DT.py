...
if __name__ == '__main__':
    ...
    if example == 1:
        ...
        trainingData = loadCSV('/Users/selmee/PycharmProjects/KBANN/Datasets/tbc.csv')  # sorry for not translating the TBC and pneumonia symptoms
    ...
    # Don' forget if you compare the resulting tree with the tree in my presentation: here it is a binary tree!
        ...
        # the bigger example
        trainingData = loadCSV('/Users/selmee/PycharmProjects/KBANN/Datasets/fishiris.csv')  # demo data from matlab
        decisionTree = growDecisionTreeFrom(trainingData)
        plot(decisionTree)
